...
// Signed add with overflow checking
func opSadd(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	x, y := stack.pop(), stack.pop()
	x = math.S256(x)
	y = math.S256(y)
...
// Unsigned add with overflow checking
func opUadd(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	x, y := stack.pop(), stack.pop()
	z := big.NewInt(0)
	z.Add(x, y)
...
// Signed sub with overflow checking
func opSsub(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	x, y := stack.pop(), stack.pop()
	x = math.S256(x)
	y = math.S256(y)
...
// Unsigned sub with overflow checking
func opUsub(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	x, y := stack.pop(), stack.pop()
	z := big.NewInt(0)
	z.Sub(x, y)
...
// Signed mul with overflow checking
func opSmul(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	x, y := stack.pop(), stack.pop()
	x = math.S256(x)
	y = math.S256(y)
...
// Unsigned mul with overflow checking
func opUmul(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	x, y := stack.pop(), stack.pop()
	z := big.NewInt(0)
	z.Mul(x, y)
